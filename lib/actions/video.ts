...
export const getVideoUploadUrl = withErrorHandling(async () => {
  ...
  console.log('Creating video with library ID:', BUNNY_LIBRARY_ID);
  console.log('Stream API URL:', `${VIDEO_STREAM_BASE_URL}/${BUNNY_LIBRARY_ID}/videos`);
  ...
  // Use the direct upload URL provided by Bunny
  const uploadUrl = `${VIDEO_STREAM_BASE_URL}/${BUNNY_LIBRARY_ID}/videos/${videoResponse.guid}`;
  
  console.log('Video response:', JSON.stringify(videoResponse, null, 2));
  console.log('Generated upload URL:', uploadUrl);
  console.log('Access key present:', !!ACCESS_KEYS.streamAccessKey);
